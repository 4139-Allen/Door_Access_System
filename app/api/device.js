...
export const bindDevice = (deviceId, userId) => post(`/api/devices/${deviceId}/bind`, { user_id: userId })

export const unbindDevice = (deviceId, userId) => del(`/api/devices/${deviceId}/unbind?user_id=${userId}`)
