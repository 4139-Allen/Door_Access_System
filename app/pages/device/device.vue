  ...
  <view class="page">
    ...
    <view v-if="admin">
      <view class="search-bar">
        ...
        <button class="btn-add" @click="openCreateModal">+ 添加</button>
      </view>
      ...
      <view v-if="devices.length > 0" class="device-list">
        <view class="device-card" v-for="device in devices" :key="device.id">
          ...
          <view class="device-actions">
            <button class="btn-sm btn-edit" @click="openEditModal(device)">编辑</button>
            <button class="btn-sm btn-delete" @click="handleDelete(device)">删除</button>
          </view>
        </view>
      </view>
