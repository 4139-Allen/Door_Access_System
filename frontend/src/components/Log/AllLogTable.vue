<template>
  <div class="table-wrapper">
    ...
    >
      ...
      <el-table-column label="位置" prop="device_location" min-width="140" show-overflow-tooltip />
      <el-table-column label="操作" prop="action" width="80" align="center">
        <template #default="{ row }">
          <el-tag
            :type="row.action === '开门' ? 'primary' : 'warning'"
            size="small"
            effect="plain"
          >
            {{ row.action }}
      ...
      <el-table-column label="时间" prop="time" width="175">
        <template #default="{ row }">
